...
import examples.BoostingOfThought.BoT_base as BoT_base
import BoT_commenter
import examples.BoostingOfThought.BoT_reasoner as BoT_reasoner
...
def _main():
    ...
    experience_reasoner = BoT_base.ExperienceRecallReasoner(
    ...
    # Define the BoT model
    bot_model = BoT_reasoner.BoostOfThoughts(
