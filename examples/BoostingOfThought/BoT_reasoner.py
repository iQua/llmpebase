...
from llmpebase.model.thought_structure import tree_thoughts


class BoostOfThoughts:
    """A base reasoner for the Boosting of Thoughts.
    ...
    def perform_global_aggregation(
        ...
        chain_prompt = BoT_base.ExperienceRecallReasoner.organize_though_chain_prompt(
        ...
        experience = BoT_base.ExperienceRecallReasoner.create_experience(
