...
rollback_controller_prompt_format = BasicThoughtPromptFormat(
    ...
    content="\n{}\n{}\n{}\n",
    target="""Please summarize the analysis within {}, and thus from the given {} steps, extract the indexes of those unnecessary, wrong, illogical, unreasonable, or vague reasoning steps. Only output the indexes after '{}'. """,
...
mathematical_reasoning_analysis_prompt_format = BasicThoughtPromptFormat(
    ...
    content="\n{}\n\n",
    target="""Double-check the reasoning process within {}, please analyze its overall and each step's correctness by checking 1) whether they are mathematical logic and rationality; 2) whether logic among them is correct. Please also report an error when any step does not contain a clear mathematical expression. """,
...
mathematical_solution_analysis_prompt_format = BasicThoughtPromptFormat(
    head="{}Toward addressing the given question, below is a reasoning process containing {} steps: \n",
    content="\n{}\n\n",
    target="""Double-check the reasoning process within {}, please analyze its overall and each step's correctness by checking whether they are mathematical logic, rationality; Please check 1) whether the final solution is presented as the numerical value; 2) whether the solution can be used to answer the given question '{}'. Please specifically report an error when the variables in the final solution are not substituted with the given value. """,
    notice="Output empty string when no steps are given.\n",
    tail="",
    prompt="",
)
