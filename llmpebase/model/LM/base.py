...
class BaseLlmRequest(torch.nn.Module):
    ...
    def configuration(self):
        ...
        # 1. Temperature [0, 1] is a parameter that controls the "creativity" or randomness of the text generated by GPT-3. A higher temperature (e.g., 0.7) results in more diverse and creative output, while a lower temperature (e.g., 0.2) makes the output more deterministic and focused.
        ...
        # 2. Top P ranges from 0 to 1 (default), and a lower Top P means the model samples from a narrower selection of words. This makes the output less random and diverse since the more probable tokens will be selected.
